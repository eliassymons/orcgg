...
function Hero() {
  return (
    <div className="w-full flex flex-col items-center justify-center py-16 gap-8 hero">
      <h1 className="text-5xl font-extrabold max-w-sm text-light  text-center px-4 leading-[4.2rem] sm:text-8xl sm:max-w-[50rem] ">
